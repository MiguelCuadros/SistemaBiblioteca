...
public class CrudUsersService implements CrudServiceSpec<Users>, RowMapper<Users> {
	...
	private final String SQL_SELECT_ACTIVE = "SELECT identifier, names, last_name, document_type, document_number, email, cellphone, active FROM users WHERE active='A'";
	private final String SQL_SELECT_INACTIVE = "SELECT identifier, names, last_name, document_type, document_number, email, cellphone, active FROM users WHERE active='I'";
	private final String SQL_SELECT_ID = "SELECT identifier, names, last_name, document_type, document_number, email, cellphone, active FROM users WHERE identifier=? AND active='A'";
	private final String SQL_SELECT_LIKE = "SELECT identifier, names, last_name, document_type, document_number, email, cellphone, active FROM users WHERE names LIKE ? AND last_name LIKE ? AND active='A'";
